...
public class TypeFragment extends BaseFragment {
    ...
    protected void initData() {
     ...
     if (ResourceUtil.resToStr(mActivity, R.string.ear).equals(mType)) {
            mTitles = ResourceUtil.stringArrayToList(mActivity, R.array.ear);
            List<String> subtypes = ResourceUtil.stringArrayToList(mActivity, R.array.ear_cat);
            for (String subtype : subtypes) {
                mFragments.add(EarFragment.newInstance(subtype));
            }
        }
    }
